...
from apps.reports.serializers.response.hazard_category_serializer import GetHazardCategoryListSerializer
...
class HazardCategoryListView(APIView):
    ...
    def get(self, request: Request) -> Response:
        ...
        return DomainResultResponse(result).respond(
            serializer_class=GetHazardCategoryListSerializer,
